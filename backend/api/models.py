...
# These tables store pre-computed metrics to speed up dashboard and analytics
# Refreshed every 15 minutes via management command
# =============================================================================
...
class DailyStatistics(models.Model):
    ...
    # Ticket counts (snapshot at time of refresh)
    ...
    # Time metrics (in seconds for precision)
...
class UserPerformanceSnapshot(models.Model):
    """Per-user daily performance metrics"""
...
class ProductSnapshot(models.Model):
    ...
    def __str__(self):
        return f"{self.product.name} stats for {self.date}"


class DepartmentSnapshot(models.Model):
    """Per-department daily statistics"""
    ...
    def __str__(self):
        return f"{self.department.name} stats for {self.date}"
